# Codewars Solutions
This is a public repository for all my Codewars solutions. The earlier files may just be the solution, but later files up to present day have comments with the URL I had for the problem and the instructions in addition to my answer.

**Profile Link**: https://www.codewars.com/users/kyaaron

## Optimizations
As I continue to get used to a certain level of difficulty, I will increase the difficulty by 1 level.
